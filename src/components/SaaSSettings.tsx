...
export default function SaaSSettings({
  ...
  return (
    <div className={cn(
      "p-5 sm:p-6 rounded-2xl border shadow-sm max-w-5xl mx-auto transition-colors duration-300",
      theme === 'dark' ? "bg-zinc-950 border-zinc-900" : "bg-white border-slate-150"
    )}>
      
      {/* Settings header */}
      <div className="border-b pb-4 mb-6 border-slate-100 dark:border-zinc-900">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 sm:gap-8">
        ...
        <div className="md:col-span-1 flex flex-row md:flex-col gap-1 overflow-x-auto pb-2 md:pb-0 scrollbar-none border-b md:border-b-0 md:border-r border-slate-100 dark:border-zinc-900 pr-0 md:pr-4">
          {tabs.map((tab) => {
            const Icon = tab.icon;
            ...
            return (
              <button
                ...
                className={cn(
                  "flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-bold transition-all text-left whitespace-nowrap cursor-pointer shrink-0 md:w-full",
                  isActive 
        ...
        <div className="md:col-span-3 min-w-0">
          ...
          {activeTab === 'profile' && (
            <div className="space-y-6 animate-fade-in">
              <form onSubmit={handleSaveProfile} className="space-y-4">
                ...
                <div className="space-y-1">
                  ...
                  <input 
                    ...
                    className={cn(
                      "w-full px-3.5 py-2.5 text-xs rounded-xl border outline-none transition-all font-semibold focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500",
                ...
                <button 
                  type="submit"
                  className="py-2 px-5 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-xl cursor-pointer"
                >
                  Save Changes
                </button>
              </form>
              ...
              <div className="h-px bg-slate-100 dark:bg-zinc-900 my-4" />
              
              <div className="space-y-4">
                <div className="flex items-center gap-2">
                  <Smartphone size={16} className="text-indigo-500" />
                  <h4 className={cn("text-xs font-bold", theme === 'dark' ? "text-slate-200" : "text-slate-850")}>
                ...
                {userPhone ? (
                  <div className="p-3.5 rounded-xl border bg-emerald-500/5 border-emerald-500/25 flex items-center justify-between gap-3">
                    <div>
                    ...
                    {!otpSent ? (
                      <form onSubmit={handleLinkPhoneSubmit} className="flex gap-2 max-w-sm">
                        <input 
                          ...
                          className={cn(
                            "flex-1 px-3.5 py-2 text-xs rounded-xl border outline-none font-semibold focus:border-indigo-500",
                            theme === 'dark' ? "bg-zinc-900 border-zinc-800 text-white" : "bg-white border-slate-200 text-slate-850"
                          )}
                        />
                        <button 
                          ...
                          className="py-2 px-4 bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-bold rounded-xl cursor-pointer disabled:opacity-50"
                        >
                      ...
                      <form onSubmit={handleVerifyOtpSubmit} className="flex gap-2 max-w-sm">
                        <input 
                          ...
                          className={cn(
                            "flex-1 px-3.5 py-2 text-xs rounded-xl border outline-none font-semibold focus:border-indigo-500 text-center tracking-widest",
                            theme === 'dark' ? "bg-zinc-900 border-zinc-800 text-white" : "bg-white border-slate-200 text-slate-850"
                          )}
                        />
                        <button 
                          type="submit"
                          disabled={isVerifyingPhone}
                          className="py-2 px-4 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl cursor-pointer disabled:opacity-50"
                        >
              ...
              <div className="space-y-3">
                ...
                <div className="grid grid-cols-2 gap-4 max-w-md">
                  ...
                  <div 
                    ...
                    className={cn(
                      "p-4 rounded-xl border cursor-pointer flex flex-col items-center gap-3 transition-all",
                      theme === 'light' 
                        ? "border-indigo-600 bg-indigo-500/5 ring-1 ring-indigo-500/10 font-bold" 
                        : "border-slate-150 bg-slate-50/50 hover:bg-slate-50 text-slate-500"
                    )}
                  >
                  ...
                  <div 
                    ...
                    className={cn(
                      "p-4 rounded-xl border cursor-pointer flex flex-col items-center gap-3 transition-all",
                      theme === 'dark' 
                        ? "border-indigo-500 bg-indigo-500/5 ring-1 ring-indigo-500/25 font-bold text-white" 
                        : "border-zinc-800 bg-zinc-900/50 hover:bg-zinc-900 text-slate-400"
                    )}
                  >
                    <Moon size={20} className={theme === 'dark' ? "text-indigo-400" : "text-zinc-600"} />
                ...
                {[
                  ...
                  <div key={item.id} className="flex items-start gap-3 justify-between">
                    <div className="space-y-0.5">
                      <p className={cn("text-xs font-bold", theme === 'dark' ? "text-slate-250" : "text-slate-800")}>
                        {item.label}
                      </p>
                    ...
                    <input 
                      type="checkbox" 
                      defaultChecked 
                      className="w-4 h-4 text-indigo-600 border-gray-300 rounded focus:ring-indigo-500 cursor-pointer accent-indigo-600 shrink-0 mt-0.5" 
                    />
                  </div>
                ))}
              </div>
          ...
          {activeTab === 'storage' && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-4 max-w-lg">
                <div className="p-4 rounded-xl border bg-slate-500/5 border-slate-200/30">
                  <h4 className={cn("text-xs font-bold flex items-center gap-1.5", theme === 'dark' ? "text-slate-200" : "text-slate-800")}>
                ...
                <div className="space-y-3">
                  ...
                  <button
                    ...
                    className="py-2 px-4.5 border border-rose-500 hover:bg-rose-500 hover:text-white text-rose-500 rounded-xl text-xs font-bold transition-all cursor-pointer active:scale-95 duration-150"
                  >
              ...
              <form onSubmit={handleSaveApiKey} className="space-y-4 max-w-lg">
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[9.5px] text-slate-400 bg-indigo-50 dark:bg-indigo-950/40 text-indigo-600 dark:text-indigo-400 border border-indigo-100/50 dark:border-indigo-900/10 px-1.5 py-0.5 rounded font-bold">
                      Stored Locally
                    </span>
                  </div>
                  <div className="relative group">
                    ...
                    <input 
                      ...
                      className={cn(
                        "w-full pl-9 pr-4 py-2.5 text-xs rounded-xl border outline-none font-semibold focus:border-indigo-500",
                        theme === 'dark' ? "bg-zinc-900 border-zinc-800 text-white" : "bg-white border-slate-200 text-slate-850"
                      )}
                    />
                  </div>
          ...
          {activeTab === 'security' && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="space-y-4">
                ...
                <div className="border rounded-xl divide-y divide-slate-100 dark:divide-zinc-900">
                  {connectedDevices.map((dev) => (
                    <div key={dev.id} className="p-3.5 flex items-center justify-between gap-4 text-xs font-semibold">
                      <div className="min-w-0">
                        <p className={cn("font-extrabold flex items-center gap-1.5", theme === 'dark' ? "text-slate-250" : "text-slate-800")}>
                          {dev.name}
                          {dev.active && (
                            <span className="px-1.5 py-0.5 rounded-full text-[8.5px] font-black uppercase tracking-wider bg-emerald-50 text-emerald-600 border border-emerald-100/40">
                              Current
                            </span>
                          )}
                        </p>
                      ...
                      {!dev.active && (
                        <button
                          ...
                          className="text-[10px] uppercase tracking-wide font-extrabold text-rose-500 hover:underline cursor-pointer"
                        >
                          Revoke
                        </button>
                      )}
          ...
          {activeTab === 'about' && (
            <div className="space-y-4 animate-fade-in">
              ...
              <div className="p-4 rounded-xl border bg-slate-500/5 border-slate-200/30 max-w-md">
                <div className="flex items-center gap-3.5">
                  <div className="w-10 h-10 rounded-xl bg-indigo-600 text-white flex items-center justify-center font-black text-sm">
                    TB
                  </div>
                  <div>
                    <h4 className={cn("font-extrabold text-sm", theme === 'dark' ? "text-slate-100" : "text-slate-800")}>
                ...
                <div className="h-px bg-slate-100 dark:bg-zinc-900 my-3.5" />

                <div className="space-y-1.5 text-[10.5px] text-slate-400 font-semibold leading-relaxed">
